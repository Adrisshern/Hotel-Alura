...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		this.setHuespedControl(new HuespedesControlador());
	...
	private void MostraTablaHuespedes() {
	...
	private void MostraTablaHuespedesID() {
	...
	private void actualizarHuespedes() {
		...
		.ifPresentOrElse(filaHuespedes ->{
			...
			if(tbHuespedes.getSelectedRow() == 6 || tbHuespedes.getSelectedColumn() ==0) {
...
//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
		...
		public HuespedesControlador getHuespedControl() {
			return huespedControl;
		}

		public void setHuespedControl(HuespedesControlador huespedControl) {
			this.huespedControl = huespedControl;
		}
}
